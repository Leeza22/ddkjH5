<template>
	<view v-if="isShow" class="picker">
		...
		<view v-if="type!='time'" class="picker-modal">
			<view class="picker-modal-info">
				<block v-if="isMultiSelect">
					<view class="picker-modal-info-fast">
						<text class="picker-modal-info-fast-btn" @click="fastChoose('week')" 
							:style="fast ==='week'?'color:#2298ef':''">最近一周</text>
						<text class="picker-modal-info-fast-btn" @click="fastChoose('month')"
							:style="fast==='month'?'color:#2298ef':''">最近一个月</text>
						<text class="picker-modal-info-fast-btn" @click="fastChoose('quarter')"
							:style="fast==='quarter'?'color:#2298ef':''">最近三个月</text>
					</view>			
				</block>
			</view>
